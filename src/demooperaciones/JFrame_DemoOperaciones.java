 ...
 * @author Lab2
 */
public class JFrame_DemoOperaciones extends javax.swing.JFrame {

    /**
     * Creates new form JFrame_DemoOperaciones
     */
    public JFrame_DemoOperaciones() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_DemoOperaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_DemoOperaciones().setVisible(true);
            }
        });
    }
